...
const patches = [
  ...
  { name:'Fat Sub',      osc1Wave:3, osc2Wave:0, osc2Semi:-12, osc1Level:105, osc2Level:45, filterCutoff:50, filterResonance:18, ampAttack:4, ampSustain:100, ampRelease:55, transpose:-12, ...MC(35) },
  ...
  { name:'Cloudy Sub',   osc1Wave:2, osc2Wave:2, osc2Tune:9,  osc1Level:100, osc2Level:82, filterCutoff:55, filterResonance:18, ampAttack:5,  ampSustain:100, ampRelease:60, transpose:-12, ...MC(35) },
  ...
  { name:'Reese',        osc1Wave:0, osc2Wave:0, osc2Tune:-7,  osc1Level:95,  osc2Level:95,  filterCutoff:65, filterResonance:52, ampAttack:3,  ampSustain:100, ampRelease:45, transpose:-12, ...MO2(20) },
  { name:'Wide Saw',     osc1Wave:0, osc2Wave:0, osc2Tune:7,   osc1Level:100, osc2Level:90,  filterCutoff:78, filterResonance:28, ampAttack:4,  ampSustain:100, ampRelease:50, transpose:-12, ...MO2(22) },
  { name:'Cloudy Reese', osc1Wave:2, osc2Wave:0, osc2Tune:-8,  osc1Level:95,  osc2Level:90,  filterCutoff:68, filterResonance:38, ampAttack:5,  ampSustain:100, ampRelease:55, transpose:-12, ...MO2(20) },
  { name:'Hoover',       osc1Wave:0, osc2Wave:0, osc2Mod:2, osc2Tune:20, osc1Level:100, osc2Level:65, filterCutoff:75, filterResonance:62, ampAttack:2, ampSustain:100, ampRelease:50, transpose:-12, ...MC(35) },
  { name:'Twin Sine',    osc1Wave:3, osc2Wave:2, osc2Tune:9,   osc1Level:100, osc2Level:80,  filterCutoff:55, filterResonance:18, ampAttack:4,  ampSustain:100, ampRelease:55, transpose:-12, ...MC(30) },
  { name:'Harmonic',     osc1Wave:0, osc2Wave:2, osc2Semi:7,   osc1Level:100, osc2Level:50,  filterCutoff:70, filterResonance:28, ampAttack:4,  ampSustain:100, ampRelease:50, transpose:-12, ...MC(30) },
  { name:'Octave Stack', osc1Wave:0, osc2Wave:0, osc2Semi:12,  osc1Level:100, osc2Level:50,  filterCutoff:75, filterResonance:30, ampAttack:3,  ampSustain:100, ampRelease:45, transpose:-12, ...MC(30) },
  { name:'Twin Pulse',   osc1Wave:1, osc2Wave:1, osc2Tune:8,   osc1Level:95,  osc2Level:90,  filterCutoff:72, filterResonance:32, ampAttack:4,  ampSustain:100, ampRelease:50, transpose:-12, ...MO2(25) },
  ...
  { name:'Stab Low',     osc1Wave:0, osc2Wave:1, osc2Semi:12, osc1Level:105, osc2Level:50, filterCutoff:85, filterResonance:48, filterEgInt:38, filterDecay:18, ampAttack:0, ampDecay:22, ampSustain:0, ampRelease:15, transpose:-12, ...MC(30) },
  ...
  { name:'Morphing',     osc1Wave:0, osc2Wave:2, osc2Tune:6, osc1Level:100, osc2Level:70, filterCutoff:55, filterResonance:52, vp1Src:2, vp1Dst:4, vp1Int:32, lfo1Wave:2, lfo1Rate:15, ampAttack:3, ampSustain:100, ampRelease:50, transpose:-12, ...ML(35) },
  ...
  { name:'Flow',         osc1Wave:2, osc2Wave:0, osc2Tune:-8, osc1Level:95, osc2Level:80, filterCutoff:58, filterResonance:38, vp1Src:2, vp1Dst:4, vp1Int:30, lfo1Wave:2, lfo1Rate:18, ampAttack:4, ampSustain:100, ampRelease:55, transpose:-12, ...MC(40) },
  ...
  { name:'Forest Bass',  osc1Wave:0, osc2Wave:0, osc2Tune:-9, osc1Level:105, osc2Level:65, filterCutoff:48, filterResonance:82, filterEgInt:48, filterDecay:30, vp1Src:2, vp1Dst:4, vp1Int:40, lfo1Wave:2, lfo1Rate:55, ampAttack:0, ampSustain:100, ampRelease:32, transpose:-12, ...ML(40) },
  ...
  { name:'Alien Groove', osc1Wave:0, osc2Wave:0, osc2Mod:1, osc2Semi:4, osc1Level:100, osc2Level:72, filterCutoff:52, filterResonance:85, filterEgInt:48, filterDecay:30, vp1Src:2, vp1Dst:4, vp1Int:42, lfo1Wave:2, lfo1Rate:60, ampAttack:0, ampSustain:100, ampRelease:32, transpose:-12, ...ML(40) },
  { name:'Spiral Bass',  osc1Wave:0, osc2Wave:0, osc2Tune:-6, osc1Level:105, osc2Level:80, filterCutoff:50, filterResonance:95, vp1Src:2, vp1Dst:4, vp1Int:50, lfo1Wave:2, lfo1Rate:65, ampAttack:0, ampSustain:100, ampRelease:35, transpose:-12, ...ML(45) },
  { name:'Psyche Sub',   osc1Wave:3, osc2Wave:0, osc2Tune:-10, osc1Level:112, osc2Level:48, filterCutoff:50, filterResonance:20, ampAttack:2, ampSustain:100, ampRelease:55, transpose:-12, ...MC(40) },
  { name:'Twisting',     osc1Wave:1, osc2Wave:2, osc2Tune:14, osc1Level:100, osc2Level:78, filterCutoff:50, filterResonance:92, vp1Src:2, vp1Dst:4, vp1Int:48, lfo1Wave:2, lfo1Rate:60, ampAttack:0, ampSustain:100, ampRelease:35, transpose:-12, ...ML(45) },

  // ── A8: Specialty Basses (57–64) — character-specific ────────────────────
  { name:'Compton',      osc1Wave:3, osc2Wave:2, osc2Tune:-8,  osc1Level:112, osc2Level:40, filterCutoff:50, filterResonance:15, ampAttack:2, ampSustain:100, ampRelease:65, transpose:-12, ...MC(30) },
  ...
  { name:'Detroit Deep', osc1Wave:0, osc2Wave:2, osc2Tune:-5, osc1Level:100, osc2Level:52, filterCutoff:55, filterResonance:45, vp1Src:2, vp1Dst:4, vp1Int:30, lfo1Wave:2, lfo1Rate:12, ampAttack:3, ampSustain:100, ampRelease:60, transpose:-12, ...MC(30) },
  ...
  { name:'Deep House',   osc1Wave:0, osc2Wave:2, osc2Tune:6, osc1Level:105, osc2Level:50, filterCutoff:63, filterResonance:35, filterEgInt:40, filterDecay:42, ampAttack:3, ampSustain:100, ampRelease:55, delayTime:30, delayDepth:18, transpose:-12, ...MC(30) },
  { name:'House Sub',    osc1Wave:3, osc2Wave:0, osc2Tune:8, osc1Level:110, osc2Level:38, filterCutoff:58, filterResonance:20, ampAttack:4, ampSustain:100, ampRelease:58, transpose:-12, ...MC(30) },
  ...
  { name:'Whistle',      osc1Wave:3, osc1Level:110, filterCutoff:100, filterResonance:10, vp1Src:3, vp1Dst:0, vp1Int:22, lfo2Wave:2, lfo2Rate:70, portamento:12, ampAttack:8, ampSustain:100, ampRelease:45, delayTime:40, delayDepth:25, vibratoIntensity:38, ...MP(28) },
  ...
  { name:'Slow Whistle', osc1Wave:3, osc1Level:108, filterCutoff:100, filterResonance:10, vp1Src:3, vp1Dst:0, vp1Int:18, lfo2Wave:2, lfo2Rate:70, portamento:15, ampAttack:10, ampSustain:100, ampRelease:50, delayTime:42, delayDepth:28, vibratoIntensity:35, ...MP(22) },
  { name:'Wide Whistle', osc1Wave:3, osc2Wave:2, osc2Tune:8, osc1Level:100, osc2Level:55, filterCutoff:98, filterResonance:12, vp1Src:3, vp1Dst:0, vp1Int:20, lfo2Wave:2, lfo2Rate:70, portamento:12, ampAttack:8, ampSustain:100, ampRelease:45, delayTime:40, delayDepth:30, vibratoIntensity:38, ...MP(22) },
  { name:'Velvet Lead',  osc1Wave:3, osc2Wave:0, osc2Semi:12, osc1Level:100, osc2Level:30, filterCutoff:92, filterResonance:22, filterEgInt:18, filterDecay:40, vp1Src:3, vp1Dst:0, vp1Int:15, lfo2Wave:2, lfo2Rate:70, portamento:14, ampAttack:6, ampSustain:100, ampRelease:48, vibratoIntensity:36, ...ML(20) },
  { name:'Smooth Lead',  osc1Wave:2, osc2Wave:2, osc2Tune:7, osc1Level:100, osc2Level:65, filterCutoff:88, filterResonance:20, vp1Src:3, vp1Dst:0, vp1Int:18, lfo2Wave:2, lfo2Rate:70, portamento:15, ampAttack:7, ampSustain:100, ampRelease:46, delayTime:38, delayDepth:22, vibratoIntensity:38, ...ML(20) },
  ...
  { name:'Wavering',     osc1Wave:0, osc2Wave:0, osc2Tune:8, osc1Level:90, osc2Level:82, filterCutoff:70, filterResonance:32, vp1Src:2, vp1Dst:0, vp1Int:20, lfo1Wave:2, lfo1Rate:70, ampAttack:6, ampSustain:100, ampRelease:52, delayTime:50, delayDepth:40, vibratoIntensity:44, ...ML(30) },
  { name:'Drift',        osc1Wave:2, osc2Wave:2, osc2Tune:11, osc1Level:88, osc2Level:84, filterCutoff:65, filterResonance:24, vp1Src:2, vp1Dst:0, vp1Int:10, lfo1Wave:2, lfo1Rate:70,  ampAttack:12, ampSustain:100, ampRelease:65, delayTime:62, delayDepth:52, vibratoIntensity:38, ...ML(30) },
